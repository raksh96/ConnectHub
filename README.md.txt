# ConnectHub - ConnectHub - An Internal Social Networking App for Startup Employees
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/raksh96/ConnectHub.git
   cd ConnectHub
   ```
...
For any questions or inquiries, please contact Rukshanda Rahman at rahmanrukshanda@gmail.com.
